...
#define  SETP_PANEL_SETDEN                18      /* control type: command, callback function: SetDenCallBack */
#define  SETP_PANEL_HIG                   19      /* control type: numeric, callback function: (none) */
#define  SETP_PANEL_DATEANDTIME           20      /* control type: textMsg, callback function: CardStaticIndicateCallBack */
#define  SETP_PANEL_CALCPARA              21      /* control type: numeric, callback function: (none) */
#define  SETP_PANEL_DEN                   22      /* control type: numeric, callback function: (none) */
#define  SETP_PANEL_DECORATION_16         23      /* control type: deco, callback function: (none) */
#define  SETP_PANEL_CALCPARA_             24      /* control type: textMsg, callback function: (none) */
...
int  CVICALLBACK SetDenCallBack(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
